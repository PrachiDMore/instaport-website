  ...
  return (
    <section className='px-5 h-auto w-screen Poppins flex flex-col items-center bg-[#fafae0]'>
      ...
      <div className='pt-[120px]'>
        <section className='w-full lg:p-7 px-5 py-4 bg-white rounded-xl border-2 border-accentYellow'>
          <h1 className='lg:text-2xl text-xl font-bold mb-4 text-center'>CANCELLATION AND REFUND</h1>
