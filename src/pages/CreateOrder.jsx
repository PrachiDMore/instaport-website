        ...
        <form onSubmit={handlePayment} className='h-auto w-screen flex flex-col items-center lg:px-24 px-5 lg:text-left text-center relative'>
          ...
          <div className='border-accentYellow border-2 bg-white lg:w-[80%] w-full h-auto flex flex-col gap-6 my-4 lg:py-8 py-4 lg:px-10 px-4 rounded-2xl'>
            ...
            <div className='flex justify-between gap-3 lg:flex-nowrap flex-wrap'>
              <button onClick={() => { setFormState({ ...formState, parcel_weight: weight[0] }) }} className={formState?.parcel_weight !== weight[0] ? 'w-[135px] outline-none rounded-xl px-5 py-2 border-accentYellow border-2 hover:shadow-md duration-200 ' : "bg-accentYellow w-[135px] outline-none rounded-xl px-5 py-2 border-accentYellow border-2 hover:shadow-md duration-200 "}>{weight[0]}</button>
              <button onClick={() => { setFormState({ ...formState, parcel_weight: weight[1] }) }} className={formState?.parcel_weight !== weight[1] ? 'w-[135px] outline-none rounded-xl px-5 py-2 border-accentYellow border-2 hover:shadow-md duration-200 ' : "bg-accentYellow w-[135px] outline-none rounded-xl px-5 py-2 border-accentYellow border-2 hover:shadow-md duration-200 "}>{weight[1]}</button>
              <button onClick={() => { setFormState({ ...formState, parcel_weight: weight[2] }) }} className={formState?.parcel_weight !== weight[2] ? 'w-[135px] outline-none rounded-xl px-5 py-2 border-accentYellow border-2 hover:shadow-md duration-200 ' : "bg-accentYellow w-[135px] outline-none rounded-xl px-5 py-2 border-accentYellow border-2 hover:shadow-md duration-200 "}>{weight[2]}</button>
              <button onClick={() => { setFormState({ ...formState, parcel_weight: weight[3] }) }} className={formState?.parcel_weight !== weight[3] ? 'w-[135px] outline-none rounded-xl px-5 py-2 border-accentYellow border-2 hover:shadow-md duration-200 ' : "bg-accentYellow w-[135px] outline-none rounded-xl px-5 py-2 border-accentYellow border-2 hover:shadow-md duration-200 "}>{weight[3]}</button>
              <button onClick={() => { setFormState({ ...formState, parcel_weight: weight[4] }) }} className={formState?.parcel_weight !== weight[4] ? 'w-[135px] outline-none rounded-xl px-5 py-2 border-accentYellow border-2 hover:shadow-md duration-200 ' : "bg-accentYellow w-[135px] outline-none rounded-xl px-5 py-2 border-accentYellow border-2 hover:shadow-md duration-200 "}>{weight[4]}</button>
            </div>
          </div>
